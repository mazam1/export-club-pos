...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapGetters)(["currentUser"])), {}, {
    ...
    costingLabel: function costingLabel() {
      return this.costingMethod === 'fifo' ? this.$t('FIFO_Method') || 'FIFO' : this.$t('Average_Cost_Method') || 'Average Cost';
    },
    cogs: function cogs() {
      return this.costingMethod === 'fifo' ? this.num(this.infos.product_cost_fifo) : this.num(this.infos.averagecost);
    },
    grossProfit: function grossProfit() {
      return this.costingMethod === 'fifo' ? this.num(this.infos.gross_profit_fifo) : this.num(this.infos.gross_profit_avg);
    },
    grossMargin: function grossMargin() {
      return this.costingMethod === 'fifo' ? this.num(this.infos.gross_margin_fifo) : this.num(this.infos.gross_margin_avg);
    },
    netProfit: function netProfit() {
      return this.costingMethod === 'fifo' ? this.num(this.infos.profit_fifo) : this.num(this.infos.profit_average_cost);
    },
    netMargin: function netMargin() {
      return this.costingMethod === 'fifo' ? this.num(this.infos.net_margin_fifo) : this.num(this.infos.net_margin_avg);
    }
  }),
  ...
  methods: {
    ...
    money: function money(v) {
      try {
        ...
        var formatted = (0,_utils_priceFormat__WEBPACK_IMPORTED_MODULE_5__.formatPriceDisplay)(n, 2, key || null);
    ...
    //------ Print Report (investor-grade layout)
    printReport: function printReport() {
      var title = "".concat(this.$t("Reports"), " / ").concat(this.$t("ProfitandLoss"));
      var period = "".concat(this.fmtDate(this.dateRange.startDate), " \u2014 ").concat(this.fmtDate(this.dateRange.endDate));
      var wh = this.warehouseLabel ? " | ".concat(this.warehouseLabel) : '';
      var method = this.costingLabel;
      var row = function row(label, value, style) {
        return "<tr".concat(style ? " style=\"".concat(style, "\"") : '', "><td style=\"padding:6px 10px;\">").concat(label, "</td><td style=\"padding:6px 10px;text-align:right;\">").concat(value, "</td></tr>");
      };
      var hdr = function hdr(label) {
        return "<tr><td colspan=\"2\" style=\"padding:8px 10px;font-weight:700;text-transform:uppercase;font-size:10px;color:#666;border-bottom:1px solid #eee;\">".concat(label, "</td></tr>");
      };
      var sep = function sep() {
        return "<tr><td colspan=\"2\" style=\"border-bottom:2px solid #333;padding:0;\"></td></tr>";
      };
      var subRow = function subRow(label, value) {
        return "<tr style=\"background:#f8f9fa;\"><td style=\"padding:8px 10px;font-weight:700;\">".concat(label, "</td><td style=\"padding:8px 10px;text-align:right;font-weight:700;\">").concat(value, "</td></tr>");
      };
      var bigRow = function bigRow(label, value, color) {
        return "<tr style=\"background:#f0f0f0;\"><td style=\"padding:10px;font-weight:700;font-size:14px;\">".concat(label, "</td><td style=\"padding:10px;text-align:right;font-weight:700;font-size:14px;color:").concat(color, ";\">").concat(value, "</td></tr>");
      };
      var t = "<table style=\"width:100%;border-collapse:collapse;font-size:12px;font-family:Arial,sans-serif;\">";
      // Header
      t += "<tr><td colspan=\"2\" style=\"text-align:center;padding:16px;font-size:16px;font-weight:700;border-bottom:2px solid #333;\">".concat(this.$t('Income_Statement') || 'Income Statement', "<br><span style=\"font-size:11px;font-weight:400;color:#666;\">").concat(period).concat(wh, " | ").concat(method, "</span></td></tr>");

      // Income
      t += hdr(this.$t('Income') || 'Income');
      t += row("".concat(this.$t('Gross_Sales') || 'Gross Sales', " (").concat(this.num(this.infos.sales_count), ")"), this.money(this.infos.sales_sum));
      t += row("".concat(this.$t('Less_Returns') || 'Less: Sales Returns', " (").concat(this.num(this.infos.returns_sales_count), ")"), "(".concat(this.money(this.infos.returns_sales_sum), ")"), 'color:#c62828;');
      ...
      t += row("".concat(this.$t('Product_Cost'), " (").concat(method, ")"), "(".concat(this.money(this.cogs), ")"));
      t += subRow("".concat(this.$t('Gross_Profit'), " (").concat(this.grossMargin, "%)"), this.money(this.grossProfit));

      // Expenses
      t += hdr(this.$t('Operating_Expenses') || 'Operating Expenses');
      t += row(this.$t('Expenses'), "(".concat(this.money(this.infos.expenses_sum), ")"));
      t += sep();

      // Net Profit
      var npColor = this.netProfit >= 0 ? '#2e7d32' : '#c62828';
      t += bigRow("".concat(this.$t('Net_Profit') || 'Net Profit', " (").concat(this.netMargin, "%)"), this.money(this.netProfit), npColor);

      // Supplementary
      t += "<tr><td colspan=\"2\" style=\"padding:12px 0 4px 0;\"></td></tr>";
      t += hdr(this.$t('Supplementary_Info') || 'Supplementary Information');
      t += row("".concat(this.$t('Purchases'), " (").concat(this.num(this.infos.purchases_count), ")"), this.money(this.infos.purchases_sum));
      t += row(this.$t('PurchasesReturn'), "(".concat(this.money(this.infos.returns_purchases_sum), ")"));
      ...
      t += row(this.$t('Cash_To_Suppliers') || 'Cash to Suppliers', "(".concat(this.money(this.infos.paiement_purchases), ")"));
      t += row(this.$t('Refunds_To_Customers') || 'Refunds to Customers', "(".concat(this.money(this.infos.PaymentSaleReturns), ")"));
      t += row(this.$t('Expenses_Paid') || 'Expenses Paid', "(".concat(this.money(this.infos.expenses_sum), ")"));
      t += subRow(this.$t('Total_Cash_Out') || 'Total Cash Out', "(".concat(this.money(this.infos.payment_sent), ")"));
      t += sep();
      var ncfColor = this.num(this.infos.paiement_net) >= 0 ? '#2e7d32' : '#c62828';
      ...
      var doc = w.document;
      doc.open();
      doc.write("<!doctype html><html><head><meta charset=\"utf-8\"/><title>".concat(title, "</title>\n        <style>@media print { @page { size: A4; margin: 1.5cm; } } body { margin: 1cm; font-family: Arial, sans-serif; }</style>\n        </head><body>").concat(t, "</body></html>"));
      doc.close();
      w.focus();
      setTimeout(function () {
        w.print();
    ...
    fetchPnl: function fetchPnl() {
      ...
      axios.get("report/profit_and_loss?from=".concat(from, "&to=").concat(to, "&warehouse_id=").concat(wh)).then(function (_ref) {
        var data = _ref.data;
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "report-header text-center mb-4"
  }, [_c("h4", {
    staticClass: "mb-1 font-weight-bold"
  }, [_vm._v(_vm._s(_vm.$t("Income_Statement") || "Income Statement"))]), _vm._v(" "), _c("p", {
    staticClass: "text-muted mb-1"
  }, [_vm._v("\n          " + _vm._s(_vm.fmtDate(_vm.dateRange.startDate)) + " — " + _vm._s(_vm.fmtDate(_vm.dateRange.endDate)) + "\n          "), _vm.warehouseLabel ? _c("span", {
    staticClass: "ml-2 badge badge-light"
  }, [_vm._v(_vm._s(_vm.warehouseLabel))]) : _vm._e()]), _vm._v(" "), _c("div", {
    staticClass: "d-inline-flex align-items-center mt-2 costing-toggle"
  }, [_c("label", {
    staticClass: "mb-0 mr-2 text-muted small"
  }, [_vm._v(_vm._s(_vm.$t("Costing_Method") || "Costing Method") + ":")]), _vm._v(" "), _c("b-form-radio-group", {
    attrs: {
      options: [{
        text: _vm.$t("FIFO_Method") || "FIFO",
        value: "fifo"
      }, {
        text: _vm.$t("Average_Cost_Method") || "Average Cost",
        value: "avg"
      }],
    ...
    model: {
      value: _vm.costingMethod,
      callback: function callback($$v) {
        _vm.costingMethod = $$v;
      },
      expression: "costingMethod"
    }
  })], 1)]), _vm._v(" "), _c("div", {
    staticClass: "pnl-table shadow-soft rounded-xl overflow-hidden mb-4"
  }, [_c("table", {
    staticClass: "table table-borderless mb-0"
  }, [_c("tbody", [_c("tr", {
    staticClass: "section-header"
  }, [_c("td", {
    staticClass: "font-weight-bold text-uppercase small text-primary",
    attrs: {
      colspan: "2"
    }
  }, [_vm._v("\n                " + _vm._s(_vm.$t("Income") || "Income") + "\n              ")])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "pl-4"
  }, [_vm._v(_vm._s(_vm.$t("Gross_Sales") || "Gross Sales") + "\n                "), _c("span", {
    staticClass: "text-muted small ml-1"
  }, [_vm._v("(" + _vm._s(_vm.num(_vm.infos.sales_count)) + ")")])]), _vm._v(" "), _c("td", {
    staticClass: "text-right"
  }, [_vm._v(_vm._s(_vm.money(_vm.infos.sales_sum)))])]), _vm._v(" "), _c("tr", {
    staticClass: "text-danger"
  }, [_c("td", {
    staticClass: "pl-4"
  }, [_vm._v(_vm._s(_vm.$t("Less_Returns") || "Less: Sales Returns") + "\n                "), _c("span", {
    staticClass: "text-muted small ml-1"
  }, [_vm._v("(" + _vm._s(_vm.num(_vm.infos.returns_sales_count)) + ")")])]), _vm._v(" "), _c("td", {
    staticClass: "text-right"
  }, [_vm._v("(" + _vm._s(_vm.money(_vm.infos.returns_sales_sum)) + ")")])]), _vm._v(" "), _c("tr", {
    staticClass: "subtotal-row"
  }, [_c("td", {
    staticClass: "font-weight-bold"
  }, [_vm._v(_vm._s(_vm.$t("Net_Revenue") || "Net Revenue"))]), _vm._v(" "), _c("td", {
    staticClass: "text-right font-weight-bold"
  }, [_vm._v(_vm._s(_vm.money(_vm.infos.total_revenue)))])]), _vm._v(" "), _c("tr", {
    staticClass: "section-header"
  }, [_c("td", {
    staticClass: "font-weight-bold text-uppercase small text-primary",
    attrs: {
  ...
  }, [_vm._v("\n                " + _vm._s(_vm.$t("Cost_of_Goods_Sold") || "Cost of Goods Sold") + "\n              ")])]), _vm._v(" "), _c("tr", {
    staticClass: "text-danger"
  }, [_c("td", {
    staticClass: "pl-4"
  }, [_vm._v(_vm._s(_vm.$t("Product_Cost")) + " (" + _vm._s(_vm.costingLabel) + ")")]), _vm._v(" "), _c("td", {
    staticClass: "text-right"
  }, [_vm._v("(" + _vm._s(_vm.money(_vm.cogs)) + ")")])]), _vm._v(" "), _c("tr", {
    staticClass: "subtotal-row highlight-green"
  }, [_c("td", {
    staticClass: "font-weight-bold"
  }, [_vm._v("\n                " + _vm._s(_vm.$t("Gross_Profit")) + "\n                "), _c("span", {
    staticClass: "badge badge-pill ml-2",
    "class": _vm.grossProfit >= 0 ? "badge-success" : "badge-danger"
  }, [_vm._v("\n                  " + _vm._s(_vm.grossMargin) + "%\n                ")])]), _vm._v(" "), _c("td", {
    staticClass: "text-right font-weight-bold",
    "class": _vm.grossProfit >= 0 ? "text-success" : "text-danger"
  }, [_vm._v("\n                " + _vm._s(_vm.money(_vm.grossProfit)) + "\n              ")])]), _vm._v(" "), _c("tr", {
    staticClass: "section-header"
  }, [_c("td", {
    staticClass: "font-weight-bold text-uppercase small text-primary",
    attrs: {
  ...
  }, [_vm._v("\n                " + _vm._s(_vm.$t("Operating_Expenses") || "Operating Expenses") + "\n              ")])]), _vm._v(" "), _c("tr", {
    staticClass: "text-danger"
  }, [_c("td", {
    staticClass: "pl-4"
  }, [_vm._v(_vm._s(_vm.$t("Expenses")))]), _vm._v(" "), _c("td", {
    staticClass: "text-right"
  }, [_vm._v("(" + _vm._s(_vm.money(_vm.infos.expenses_sum)) + ")")])]), _vm._v(" "), _c("tr", {
    staticClass: "net-profit-row"
  }, [_c("td", {
    staticClass: "font-weight-bold"
  }, [_vm._v("\n                " + _vm._s(_vm.$t("Net_Profit") || "Net Profit") + "\n                "), _c("span", {
    staticClass: "badge badge-pill ml-2",
    "class": _vm.netProfit >= 0 ? "badge-success" : "badge-danger"
  }, [_vm._v("\n                  " + _vm._s(_vm.netMargin) + "%\n                ")])]), _vm._v(" "), _c("td", {
    staticClass: "text-right font-weight-bold",
    "class": _vm.netProfit >= 0 ? "text-success" : "text-danger"
  }, [_vm._v("\n                " + _vm._s(_vm.money(_vm.netProfit)) + "\n              ")])])])])]), _vm._v(" "), _c("div", {
    staticClass: "mb-3"
  }, [_c("b-card", {
    staticClass: "shadow-soft border-0 rounded-xl",
    attrs: {
      "no-body": ""
    }
  }, [_c("b-card-header", {
    staticClass: "p-0 border-0 bg-white",
    attrs: {
      "header-tag": "header",
      role: "tab"
    }
    ...
    directives: [{
      name: "b-toggle",
      rawName: "v-b-toggle.collapse-purchases",
      modifiers: {
        "collapse-purchases": true
      }
    }],
    staticClass: "text-left text-dark font-weight-bold px-3 py-2",
    attrs: {
      block: "",
      variant: "link"
    }
  }, [_c("i", {
    staticClass: "i-Arrow-Down-2 mr-1 toggle-icon"
  }), _vm._v("\n              " + _vm._s(_vm.$t("Supplementary_Info") || "Supplementary Information") + "\n            ")])], 1), _vm._v(" "), _c("b-collapse", {
    attrs: {
  ...
  }, [_c("tr", [_c("td", [_vm._v(_vm._s(_vm.$t("Purchases")) + " "), _c("span", {
    staticClass: "text-muted small"
  }, [_vm._v("(" + _vm._s(_vm.num(_vm.infos.purchases_count)) + ")")])]), _vm._v(" "), _c("td", {
    staticClass: "text-right"
  }, [_vm._v(_vm._s(_vm.money(_vm.infos.purchases_sum)))])]), _vm._v(" "), _c("tr", [_c("td", [_vm._v(_vm._s(_vm.$t("PurchasesReturn")) + " "), _c("span", {
    staticClass: "text-muted small"
  }, [_vm._v("(" + _vm._s(_vm.num(_vm.infos.returns_purchases_count)) + ")")])]), _vm._v(" "), _c("td", {
    staticClass: "text-right"
  }, [_vm._v("(" + _vm._s(_vm.money(_vm.infos.returns_purchases_sum)) + ")")])]), _vm._v(" "), _c("tr", {
    staticClass: "border-top"
  }, [_c("td", {
    staticClass: "font-weight-bold"
  }, [_vm._v(_vm._s(_vm.$t("Net_Purchases") || "Net Purchases"))]), _vm._v(" "), _c("td", {
    staticClass: "text-right font-weight-bold"
  }, [_vm._v(_vm._s(_vm.money(_vm.num(_vm.infos.purchases_sum) - _vm.num(_vm.infos.returns_purchases_sum))))])])])])], 1)], 1)], 1), _vm._v(" "), _c("div", {
    staticClass: "mb-4"
  }, [_c("b-card", {
    staticClass: "shadow-soft border-0 rounded-xl",
    attrs: {
    ...
    directives: [{
      name: "b-toggle",
      rawName: "v-b-toggle.collapse-cashflow",
      modifiers: {
        "collapse-cashflow": true
      }
    }],
    staticClass: "text-left text-dark font-weight-bold px-3 py-2",
    attrs: {
    ...
    staticClass: "i-Arrow-Down-2 mr-1 toggle-icon"
  }), _vm._v("\n              " + _vm._s(_vm.$t("Cash_Flow_Summary") || "Cash Flow Summary") + "\n            ")])], 1), _vm._v(" "), _c("b-collapse", {
    attrs: {
      id: "collapse-cashflow",
      visible: ""
    }
  }, [_c("b-card-body", {
    staticClass: "pt-0"
    ...
    staticClass: "font-weight-bold text-uppercase pb-0",
    attrs: {
      colspan: "2"
    }
  }, [_vm._v(_vm._s(_vm.$t("Total_Cash_In") || "Total Cash In"))])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "pl-3"
  }, [_vm._v(_vm._s(_vm.$t("Cash_From_Customers") || "Cash from Customers"))]), _vm._v(" "), _c("td", {
    staticClass: "text-right"
  }, [_vm._v(_vm._s(_vm.money(_vm.infos.paiement_sales)))])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "pl-3"
  }, [_vm._v(_vm._s(_vm.$t("Refunds_From_Suppliers") || "Refunds from Suppliers"))]), _vm._v(" "), _c("td", {
    staticClass: "text-right"
  }, [_vm._v(_vm._s(_vm.money(_vm.infos.PaymentPurchaseReturns)))])]), _vm._v(" "), _c("tr", {
    staticClass: "border-top"
  }, [_c("td", {
    staticClass: "font-weight-bold"
  }, [_vm._v(_vm._s(_vm.$t("Total_Cash_In") || "Total Cash In"))]), _vm._v(" "), _c("td", {
    staticClass: "text-right font-weight-bold text-success"
  }, [_vm._v(_vm._s(_vm.money(_vm.infos.payment_received)))])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "py-1",
    attrs: {
      colspan: "2"
    }
  ...
  }, [_vm._v(_vm._s(_vm.$t("Total_Cash_Out") || "Total Cash Out"))])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "pl-3"
  }, [_vm._v(_vm._s(_vm.$t("Cash_To_Suppliers") || "Cash to Suppliers"))]), _vm._v(" "), _c("td", {
    staticClass: "text-right"
  }, [_vm._v("(" + _vm._s(_vm.money(_vm.infos.paiement_purchases)) + ")")])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "pl-3"
  }, [_vm._v(_vm._s(_vm.$t("Refunds_To_Customers") || "Refunds to Customers"))]), _vm._v(" "), _c("td", {
    staticClass: "text-right"
  }, [_vm._v("(" + _vm._s(_vm.money(_vm.infos.PaymentSaleReturns)) + ")")])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "pl-3"
  }, [_vm._v(_vm._s(_vm.$t("Expenses_Paid") || "Expenses Paid"))]), _vm._v(" "), _c("td", {
    staticClass: "text-right"
  }, [_vm._v("(" + _vm._s(_vm.money(_vm.infos.expenses_sum)) + ")")])]), _vm._v(" "), _c("tr", {
    staticClass: "border-top"
  }, [_c("td", {
    staticClass: "font-weight-bold"
  }, [_vm._v(_vm._s(_vm.$t("Total_Cash_Out") || "Total Cash Out"))]), _vm._v(" "), _c("td", {
    staticClass: "text-right font-weight-bold text-danger"
  }, [_vm._v("(" + _vm._s(_vm.money(_vm.infos.payment_sent)) + ")")])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "py-1",
    attrs: {
      colspan: "2"
    }
    ...
    staticClass: "font-weight-bold"
  }, [_vm._v(_vm._s(_vm.$t("NetCashFlow") || "Net Cash Flow"))]), _vm._v(" "), _c("td", {
    staticClass: "text-right font-weight-bold",
    "class": _vm.num(_vm.infos.paiement_net) >= 0 ? "text-success" : "text-danger"
  }, [_vm._v("\n                    " + _vm._s(_vm.money(_vm.infos.paiement_net)) + "\n                  ")])])])])], 1)], 1)], 1)])], 1)], 1);
};
var staticRenderFns = [];
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.rounded-xl[data-v-b6b30cee] { border-radius: 1rem;\n}\n.shadow-soft[data-v-b6b30cee] { box-shadow: 0 12px 24px rgba(0,0,0,0.06), 0 2px 6px rgba(0,0,0,0.05);\n}\n.toolbar-card[data-v-b6b30cee] { background: #fff;\n}\n.btn-pill[data-v-b6b30cee] { border-radius: 999px;\n}\n.w-280[data-v-b6b30cee] { width: 280px;\n}\n.report-header h4[data-v-b6b30cee] { color: #1a1a2e;\n}\n.costing-toggle .btn[data-v-b6b30cee] { font-size: 0.8rem;\n}\n.pnl-table[data-v-b6b30cee] { background: #fff;\n}\n.pnl-table table[data-v-b6b30cee] { margin: 0;\n}\n.pnl-table td[data-v-b6b30cee] { padding: 10px 16px; vertical-align: middle;\n}\n.section-header td[data-v-b6b30cee] {\n  padding-top: 16px !important;\n  padding-bottom: 6px !important;\n  border-bottom: 1px solid #e8e8e8;\n  letter-spacing: 0.05em;\n}\n.subtotal-row[data-v-b6b30cee] {\n  background: #f8f9fa;\n  border-top: 1px solid #dee2e6;\n}\n.subtotal-row td[data-v-b6b30cee] { padding: 12px 16px !important;\n}\n.highlight-green[data-v-b6b30cee] { background: #f0fdf4 !important;\n}\n.net-profit-row[data-v-b6b30cee] {\n  background: linear-gradient(135deg, #f5f5f5, #ebebeb);\n  border-top: 2px solid #333;\n}\n.net-profit-row td[data-v-b6b30cee] {\n  padding: 14px 16px !important;\n  font-size: 1.1rem;\n}\n.toggle-icon[data-v-b6b30cee] { transition: transform 0.2s;\n}\n.collapsed .toggle-icon[data-v-b6b30cee] { transform: rotate(-90deg);\n}\n.daterangepicker[data-v-b6b30cee] { z-index: 2055 !important;\n}\n@media (max-width: 576px) {\n.daterangepicker[data-v-b6b30cee] {\n    left: 8px !important; right: 8px !important;\n    width: auto !important; max-width: calc(100vw - 16px) !important;\n}\n.daterangepicker .drp-calendar[data-v-b6b30cee], .daterangepicker .ranges[data-v-b6b30cee] {\n    float: none !important; width: 100% !important;\n}\n.quick-ranges[data-v-b6b30cee] {\n    display: flex !important; flex-wrap: wrap; width: 100%;\n}\n.quick-ranges .btn[data-v-b6b30cee] {\n    flex: 1 1 calc(50% - 6px); margin-bottom: 6px;\n}\n}\n", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
