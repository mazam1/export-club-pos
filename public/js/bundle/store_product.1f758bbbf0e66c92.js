  ...
  created: function created() {
    ...
    if (duplicateId) {
      ...
      axios.get("products/".concat(duplicateId, "/edit")).then(function (response) {
        ...
        _this14.product.weight = p.weight != null ? String(p.weight) : _this14.product.weight;
        _this14.product.length = p.length != null ? String(p.length) : _this14.product.length;
        _this14.product.width = p.width != null ? String(p.width) : _this14.product.width;
        _this14.product.height = p.height != null ? String(p.height) : _this14.product.height;
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "mb-2"
  }, [_vm._v(_vm._s(_vm.$t("Dimensions_in")))])]) : _vm._e(), _vm._v(" "), _vm.product.type != "is_service" ? _c("b-col", {
    staticClass: "mb-3",
    attrs: {
      md: "4"
    }
