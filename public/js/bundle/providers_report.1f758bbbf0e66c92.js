...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    printTableOnly: function printTableOnly() {
      ...
      providersData.forEach(function (row) {
        ...
        _this.columns.filter(function (col) {
          ...
          if (['total_amount', 'total_paid', 'due', 'return_Due'].includes(col.field)) {
            cellContent = _this.formatNumber(row[col.field], 2);
          }
      ...
      tableHtml += "<td class=\"text-left font-weight-bold\">".concat(this.formatNumber(totalAmount, 2), "</td>");
      tableHtml += "<td class=\"text-left font-weight-bold\">".concat(this.formatNumber(totalPaid, 2), "</td>");
      tableHtml += "<td class=\"text-left font-weight-bold\">".concat(this.formatNumber(totalDue, 2), "</td>");
      tableHtml += "<td class=\"text-left font-weight-bold\">".concat(this.formatNumber(totalReturnDue, 2), "</td>");
      tableHtml += "</tr></tfoot>";
      tableHtml += "</table>";
